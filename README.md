...
[![Framework: Antigravity](https://img.shields.io/badge/Framework-Antigravity-orange.svg)](#)
...
```mermaid
graph TD
    A[RFP/Template PDF] --> B(STAGE 1: Context Agent)
    B --> C{STAGE 2: Researcher}
    C -->|NotebookLM MCP| D[Deep Research DB]
    D --> E(STAGE 3: Architect Agent)
    E -->|GATE 1: Human| F(STAGE 4: Writer Teams)
    F -->|Phase 1: Relay| G[Section Drafts]
    G --> H(STAGE 5: Reviewer Agent)
    H -->|GATE 2: Human| I[Final MD/DOCX]
```
